    ...
    return (
        <form className={`${styles.mainpage}`} onSubmit={submitHandler}>
            ...
            <div className={styles.middle}>
                <h2>
                    Registering a domain name requires you to complete these
                    steps:{" "}
                </h2>
                {existingBid && (
                    <div className={styles.steps}>
                        <div className={styles.step}>
                            ...
                            <span>
                                <h4>New Auction</h4>
                                <p>
                                    Enter domain name to check for availability{" "}
                                </p>
                            </span>
                        </div>
                        <div className={styles.step}>
                            ...
                            <span>
                                ...
                                <span className={styles.note}>
                                    <ol>
                                        ...
                                        <li>
                                            Bid amount cannot be changed once
                                            committed
                                        </li>
                                    </ol>
                                </span>
                        ...
                        <div className={styles.step}>
                            ...
                            <span>
                                <h4>Register</h4>
                                <p>
                                    Hit the register button to commit your bid!{" "}
                                </p>
                            </span>
                        </div>
                    </div>
